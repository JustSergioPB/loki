...
export class Form {
  ...
  private _latestVersion: FormVersion;
  private _publisedVersion: FormVersion | undefined;
  ...
  fill(
    ...
    return {
      ...
      proof: {
        ...
        verificationMethod: issuer.signingLabel,
